...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Cherry Hub chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Cherry Hub", HidePremium = false, IntroText = "Cherry Hub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Cherry Hub SCRIPT")
W:AddLabel("DiscordCherry Hub")
local Section = W:AddSection({
    Name = "Status"
})
